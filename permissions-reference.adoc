...
.2+| FSx for ONTAPファイルシステムのセキュリティグループの出力と入力を管理 | EC2: RevokeSecurityGroupIngress | カンリシヨリ | ファイルシステムの作成と削除 


| EC2: DeleteSecurityGroup | カンリシヨリ | ファイルシステムの作成と削除 


.17+| FSx for ONTAPファイルシステムリソースの作成、表示、管理 | FSx：ボリュームの作成 | カンリシヨリ | 運用と修復 
