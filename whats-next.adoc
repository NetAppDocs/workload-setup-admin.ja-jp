...
---
= NetApp Workload Factory のワークロード機能
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* https://docs.netapp.com/us-en/workload-eda/index.html["EDAワークロード"^]
+
複数のファイルシステムにわたって FSx for ONTAPを最適化し、自動化されたストレージ パラメータ管理を通じてパフォーマンスを向上させ、運用コストを削減します。
