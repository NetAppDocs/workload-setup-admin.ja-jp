...
| レプリケーション遅延 | レプリケーションに予想以上に時間がかかっています。 | レプリケーション | 致命的 | 一般的な保管 | ONTAPファイルシステム用の FSx 


| カスタムダッシュボードの作成に成功しました | カスタムダッシュボードが正常に作成され、表示できるようになりました。 | カスタムダッシュボード | 成功 | 一般的な保管 | Workload Factory アカウント 


| カスタムダッシュボードの作成に失敗しました | Workload Factory は、お客様のカスタムダッシュボードを作成できませんでした。ダッシュボードをもう一度作成してみてください。 | カスタムダッシュボード | エラー | 一般的な保管 | Workload Factory アカウント 
|===
